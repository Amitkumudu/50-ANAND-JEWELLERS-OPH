...
Public Class CrtpaymentvocucherPrint_multi
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CrtpaymentvocucherPrint_multi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrtpaymentvocucherPrint_multi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrtpaymentvocucherPrint_multi = New CrtpaymentvocucherPrint_multi
        rpt.Site = Me.Site
        Return rpt
    End Function
