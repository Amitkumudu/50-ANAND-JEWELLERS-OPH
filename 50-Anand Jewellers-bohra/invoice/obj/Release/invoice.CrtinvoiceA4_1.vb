...
Public Class invoiceCrtinvoiceA4_1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "invoice.CrtinvoiceA4_1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedinvoiceCrtinvoiceA4_1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As invoiceCrtinvoiceA4_1 = New invoiceCrtinvoiceA4_1
        rpt.Site = Me.Site
        Return rpt
    End Function
